...
import { extractShipmentFacts, type ShipmentFacts } from "../domain/workflow";
import { lookupProcedures, type Direction, type Mode } from "./intake/lookup";
import { buildStepPlan, type StepPlan } from "./intake/plan";
import { isTradeQuery } from "./intake/relevance";
import { CATEGORIES, commodityOf, type Category, type CommodityHit } from "./intake/taxonomy";
