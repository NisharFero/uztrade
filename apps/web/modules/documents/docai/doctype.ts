...
const TITLES: [RegExp, DocType][] = [
  ...
  [/\bcmr\b|международная товарно-транспортная/i, "cmr_note"],
  [/ветеринарный сертификат|veterinary certificate/i, "veterinary_certificate"],
  [/сертификат соответствия|certificate of conformity/i, "certificate_of_conformity"],
