...
import { applyCorrections, composeDocument, composeField, GATE } from "../app/lib/docai/compose";
import { crossCheck } from "../app/lib/docai/crosscheck";
import { detectDocType, originForm } from "../app/lib/docai/doctype";
import { normalizeDate, normalizeValue, parseNumber, parseTonnes } from "../app/lib/docai/validate";
import { DOC_SPECS, specFor, type DocType } from "../app/lib/document-specs";
