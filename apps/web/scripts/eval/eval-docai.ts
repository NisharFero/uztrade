...
import { composeDocument, type ExtractedField } from "../../modules/documents/docai/compose";
...
function demoCases(): Case[] {
  const scenario = JSON.parse(readFileSync(fileURLToPath(new URL("../../modules/demo/data/scenario-868.json", import.meta.url)), "utf8")) as {
