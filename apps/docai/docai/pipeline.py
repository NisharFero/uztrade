...
# a 549 px thumbnail tripled the time without reading anything more (bench/*.py).
MAX_WIDTH = 1280
MAX_PAGES = 6
# An unreadable page (bench/readability.py): the thumbnails had text 6-8 px high and
