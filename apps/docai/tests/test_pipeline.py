...
def test_large_scans_are_downscaled_to_the_ocr_width():
    # A4 at 300 dpi: same OCR accuracy at 1240 px, a third of the time (bench/resolution.py).
...
def test_small_images_are_not_upscaled():
    # Upscaling the 549 px specimen tripled OCR time and read nothing more (bench/ocr.py).
